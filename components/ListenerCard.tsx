        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-3 md:p-4 text-center border border-slate-100 dark:border-slate-700 transition-all duration-300 transform hover:scale-105 hover:shadow-cyan-500/20 group">
            <div className="relative">
                <img 
                    src={listener.image} 
                    alt={listener.name} 
                    className="w-24 h-24 md:w-28 md:h-28 rounded-full mx-auto mb-3 border-4 border-slate-100 dark:border-slate-700 object-cover" 
                />
                <div className="absolute top-0 right-1 md:right-3 bg-white dark:bg-slate-800 rounded-full p-0.5">

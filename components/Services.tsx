    ...
    <section id="services" className="py-16 md:py-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">अपनी सुविधा के अनुसार प्लान चुनें। आपके खरीदे गए प्लान 'मेरे प्लान्स' सेक्शन में जुड़ जाएंगे।</p>
        </div>
        
        <FreeTrialBanner />

        <PlanCategory title="अभी आज़माएँ" gridClass="md:grid-cols-1">
        ...
        <PlanCategory title="वैल्यू पैक्स" gridClass="md:grid-cols-2 lg:grid-cols-2">
            <PlanCard
        ...
        <PlanCategory title="सबसे लोकप्रिय" gridClass="md:grid-cols-1">
             <div className="max-w-sm mx-auto w-full">
                <PlanCard
        ...
        <PlanCategory title="प्रीमियम" gridClass="md:grid-cols-1">
            <div className="max-w-sm mx-auto w-full">
                <PlanCard
